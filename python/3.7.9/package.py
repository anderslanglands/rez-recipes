...
ln -s $REZ_BUILD_INSTALL_PATH/bin/python3-config $REZ_BUILD_INSTALL_PATH/bin/python-config && \
ln -s $REZ_BUILD_INSTALL_PATH/include/python3.7m $REZ_BUILD_INSTALL_PATH/bin/python3.7 && \
ln -s $REZ_BUILD_INSTALL_PATH/include/python3.7 $REZ_BUILD_INSTALL_PATH/bin/python
"""
